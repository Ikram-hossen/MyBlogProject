...
@endpush
@section('title', 'All Pending Posts')
...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
               <div class="header">
                    <h2>ALL PENDING POSTS <span class="badge bg-blue">{{$posts->count()}}</span></h2>
                               ...
                               @foreach($posts  as $key=>$post)
                                   <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.post.show', $post->id)}}" class="btn btn-primary waves-effect" style="margin-bottom:5px;">
                                                <i class="material-icons">visibility</i>
                                            </a>
                                            <a href="{{ route('admin.post.edit', $post->id)}}" class="btn btn-info waves-effect" style="margin-bottom:5px;">
